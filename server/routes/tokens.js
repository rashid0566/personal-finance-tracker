...
//Generating a link token to be used by the client
...
//Exchangeing a public token for an access token. Then, fetching a bunch of information about that item and stores it in our database
...
router.post("/exchange_public_token", async (req, res, next) => {
  try {
    ...
    // Calling sync for the first time to activate the sync webhooks
